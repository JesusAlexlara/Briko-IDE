...
var c_cppHighlightRules = function() {
    ...
    var keywordControls = (
        ...
        "return|switch|while|code"
    );
    
    var storageType = (
        "|bool|char|float" +
        "|int|long|short|signed|struct|void|" + 
        "ledsbk|buttonsbk|distacebk|buzzerbk|knobbk|temperaturebk|lightbk|displaybk|motorbk|"
    );
    ...
    var storageMetod = (
        "read|readbits|beep|playtone|turn|brightness|color|print|printindividual|printcustom|set"
    );

    var keywordMapper = this.$keywords = this.createKeywordMapper({
        "keyword.control" : keywordControls,
        "storage.type" : storageType,
        "variable.language": storageMetod,
